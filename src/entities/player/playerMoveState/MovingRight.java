...
public class MovingRight implements PlayerMoveState {
    private Player player;
    private Collider coll;

    public MovingRight(Player player){
        this.player=player;
    }
    ...
    public void move(double deltaTime){
        ...
        this.coll=new Collider(posX + Player.COLLIDER_SHIFT_WIDTH / 1.34,posY+Player.COLLIDER_SHIFT_HEIGHT*1.1, Entity.SPRITE_WIDTH - Player.COLLIDER_SHIFT_WIDTH
