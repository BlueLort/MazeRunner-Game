...
public class MovingUp  implements PlayerMoveState {
    private Player player;
    private Collider coll;
    public MovingUp(Player player){
        this.player=player;
    }
    @Override
    public void move(double deltaTime){
        ...
        this.coll=new Collider(posX + Player.COLLIDER_SHIFT_WIDTH/1.35 ,posY+Player.COLLIDER_SHIFT_HEIGHT,(Entity.SPRITE_WIDTH - Player.COLLIDER_SHIFT_WIDTH)/1.7
